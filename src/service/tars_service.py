...
class TarsService:
    ...
    def __init__(self, tars_url, tars_token, app_name, deploy_ip, deploy_real_ip):
        self.tars_url = tars_url
        self.tars_token = tars_token
        self.deploy_ip = deploy_ip
        self.deploy_real_ip = deploy_real_ip
    ...
    def deploy_single_service(self, service_name, obj_name_list, allow_duplicated):
        ...
        for obj_name in obj_name_list:
            ...
            # for adapters should use ip @toby
            adapters.append({"obj_name": obj_name, "port": port, "bind_ip": self.deploy_real_ip, "port_type": "tcp",
